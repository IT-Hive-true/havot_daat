...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>ערוך משרד עורכי דין</title>
</head>
<body>
<div id="content">

<form id="AddLawyerForm" name="AddLawyerForm" method="post">
...
<tr>
	<td align="left">
		<a><button type="button" onClick="if(lawyerFormValidator()) {editLawyerFirmSend();}">שמור</button>
	</td>
</tr>
</table>
</form>
