...
elseif (mysqli_num_rows($result))
{
	...
	for ($i=0;(($i<$rowsNum) && ($i<$casesInPage));$i++)
	{
		...
		echo "<tr class=\"linkble\" onclick=\"TINY.box.show({url:'editLawyerFirm.php?id=".$caseRow[0]."',width:400,height:270,closejs:function(){ window.location.reload( true ); }})\">";
			echo "<td>";
				echo $caseRow[0];
			echo "</td>";
			echo "<td>";
...
{
	echo "<BR /><BR /><center><b><p>אין משרדי עו\"ד במערכת</p></b></center><BR /><BR /><BR />";
}
